...
sql_create = "CREATE TABLE allcardata(specid VARCHAR(20),category VARCHAR(50), carvalue VARCHAR(100))ENGINE=INNODB"
            ...
            if (len(result_specid) > 0):
                ...
                for x in range(1, i + 1, 1):
                    ...
                    for j in range(1, linesnum, 1):
                        ...
                        a3 = a3.replace('\n', '')
                        sql_insert = "insert into allcardata(specid,category,carvalue) VALUES (\'%s\',\'%s\',\'%s\')" % (
                            a1, a2, a3)
